			...
			<div id="mainContent">
				<div class="row text-center justify-content-md-center">
					...
					<div class="col-md-10 col-sm-12 bd bgc-white p-20 text-left mT-40">
						...
						<form action="ave" method="POST">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="obsInicial"
									placeholder="Ingresa la observación inicial" value="<%=temporal.getObsInicial() %>"></textarea>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
						...
						<form action="ave" method="POST">
							<input type="hidden" value="9" name="seleccion">
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="fechaIngreso">Fecha de ingreso</label> <input
										autofocus type="date" class="form-control" name="fechaIngreso"

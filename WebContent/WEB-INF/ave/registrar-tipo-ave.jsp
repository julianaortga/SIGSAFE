				...
				<div class="row text-center justify-content-md-center">
					...
					<div class="col-md-10 col-sm-12 bd bgc-white p-20 text-left mT-40">
						...
						<form action="ave" method="POST">
							<input type="hidden" value="18" name="seleccion"> <input
								type="hidden" value="<%=temporal.getIdTipoAve()%>" name="id">
							<div class="form-group">
								<div class="form-group col-md-12" class="text-left">
									<label for="nombre" class="text-left">Nombre del tipo
										de ave</label> <input type="text" class="form-control" name="nombre"
						...
						<!-- Registrar -->
						<form action="ave" method="POST">
							<input type="hidden" value="6" name="seleccion">
							<div class="form-group">
								<div class="form-group col-md-12" class="text-left">
									<label for="nombre" class="text-left">Nombre del tipo
										de ave</label> <input type="text" class="form-control" name="nombre"

  ...
  <div class="peers ai-s fxw-nw h-100vh">
    ...
    <div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
      ...
      <form action="seguridad" method="POST">	
        <div class="form-group"><label class="text-normal text-dark">Correo electrónico</label> <input name="correo" type="email" class="form-control"
            placeholder="Ingresa tu email"></div>
        <div class="form-group"><label class="text-normal text-dark">Contraseña</label> <input name="contrasena" type="password" class="form-control"
            placeholder="Ingresa tu contraseña"></div>
        <div class="form-group">
          <div class="peers ai-c jc-sb fxw-nw">
            ...
            <div class="peer"><button href="index.jsp" class="btn btn-danger">Iniciar sesión</button></div>
          </div>
        </div>
      </form>
    </div>
